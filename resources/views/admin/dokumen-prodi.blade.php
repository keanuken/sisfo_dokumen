...
@section('title', 'Tambah Dokumen Prodi')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tambah Dokumen Prodi</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card card-primary mt-10">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('admin.store-dokumen') }}" method="POST" enctype="multipart/form-data">
                @csrf
                {{-- alert --}}
                @if (session('success'))
                        ...
                        <div class="d-flex flex-col justify-content-beetween">
                            <select name="subSubKategori" id="subSubKategori" class="js-states form-control"
                                ...
                                @foreach ($subSubKategori as $subsub)
                                    <option value="{{ $subsub->id_subSubKategori }}">
